...
bool requestPermission () {
    ...
    if ((WiFiMulti.run() == WL_CONNECTED)) {
        ...
        if (http.begin(client, "http://192.168.7.77")) {  // HTTP
            ...
            if (httpCode > 0) {
                ...
                if (httpCode == HTTP_CODE_OK && http.getString() == "GO") {
                    stateToRequest = relayOn;
                }
            } else {
